...
#运行nginx
#docker run --name nginx -p 80:80 -v /app/docker/nginx/conf/nginx.conf:/etc/nginx/nginx.conf -v /app/docker/nginx/logs:/var/log/nginx -v /app/docker/nginx/conf/www:/etc/nginx/conf.d -d nginx
